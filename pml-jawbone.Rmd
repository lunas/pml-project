...
The dataset consists of 160 variables provided by the accelerometers. It has 19622 records; for each record, the correct type of behavior (from "A" to "D") is given, too.
...
The error rate on the training set is 0.23%. 
